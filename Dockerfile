...
RUN dnf install -y \
  ...
  # Download Chrome drivers directly from the repository
  #&& wget -q "https://chromedriver.storage.googleapis.com/105.0.5195.19/chromedriver_linux64.zip" \
